...
Current mandatory authority: PR #419 UI v3 Rebuild F — guides and secondary pages.
...
PR #419 may redesign only the existing guide and secondary HTML route families: `/guides/`, `/guides/[article]/`, `/methodology/`, `/about/`, `/glossary/`, `/models/`, `/updates/`, `/maintenance/`, `/contact/`, `/support/`, `/compare/`, `/access-regulation/`, `/timeline/`, and `/stats/`. Guides prioritize bounded reading width, table of contents, callouts, examples, section navigation, responsive tables, and source presentation. Secondary tools preserve visible inputs/state, bounded results, freshness/readiness/absence semantics, shareable state, and machine-readable projections.
