...
import batchAE from '../../../data/batch-ae-income.json';
import batchAF from '../../../data/batch-af-income.json';
...
const profiles = [...batchA,...batchB,...batchC,...batchD,...batchE,...batchF,...batchG,...batchH,...batchJ,...batchK,...batchL,...batchMA,...batchMB,...batchN,...batchO,...batchP,...batchQ,...batchR,...batchS,...batchT,...batchU,...batchV,...batchW,...batchX,...batchY,...batchZ,...batchAA,...batchAB,...batchAC,...batchAD,...batchAE,...batchAF] as IncomeProfileV3[];
