...
import batchAG from '../../../data/batch-ag-income.json';
import batchAH from '../../../data/batch-ah-income.json';
import batchAI from '../../../data/batch-ai-income.json';
...
import batchAN from '../../../data/batch-an-income.json';
...
const profiles = [...batchA,...batchB,...batchC,...batchD,...batchE,...batchF,...batchG,...batchH,...batchJ,...batchK,...batchL,...batchMA,...batchMB,...batchN,...batchO,...batchP,...batchQ,...batchR,...batchS,...batchT,...batchU,...batchV,...batchW,...batchX,...batchY,...batchZ,...batchAA,...batchAB,...batchAC,...batchAD,...batchAE,...batchAF,...batchAG,...batchAH,...batchAI,...batchAJ,...batchAK,...batchAL,...batchAM,...batchAN] as IncomeProfileV3[];
