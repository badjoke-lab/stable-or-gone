...
const legalProfiles = [
  ...
  ...legalProfilesGrowthAB, ...legalProfilesGrowthAC,
] as LegalProfileV3[];
...
const reserveComponents = [
  ...
  ...reserveComponentsBatchY, ...reserveComponentsBatchZ, ...reserveComponentsBatchAA, ...reserveComponentsBatchAB, ...reserveComponentsBatchAC,
