...
import legalProfilesGrowthAF from '../../../data/af-legal.json';
import legalProfilesGrowthAG from '../../../data/ag-legal.json';
import legalProfilesGrowthAH from '../../../data/ah-legal.json';
import legalProfilesGrowthAI from '../../../data/ai-legal.json';
import legalProfilesGrowthAJ from '../../../data/aj-legal.json';
import legalProfilesGrowthAK from '../../../data/ak-legal.json';
import legalProfilesGrowthAL from '../../../data/al-legal.json';
import legalProfilesGrowthAM from '../../../data/am-legal.json';
import legalProfilesGrowthAN from '../../../data/an-legal.json';
...
import reserveComponentsBatchAF from '../../../data/batch-af-components.json';
import reserveComponentsBatchAG from '../../../data/batch-ag-components.json';
import reserveComponentsBatchAH from '../../../data/batch-ah-components.json';
import reserveComponentsBatchAI from '../../../data/batch-ai-components.json';
...
import reserveComponentsBatchAL from '../../../data/batch-al-components.json';
import reserveComponentsBatchAM from '../../../data/batch-am-components.json';
import reserveComponentsBatchAN from '../../../data/batch-an-components.json';
...
const legalProfiles = [
  ...
  ...legalProfilesGrowthAF, ...legalProfilesGrowthAG, ...legalProfilesGrowthAH, ...legalProfilesGrowthAI,
  ...legalProfilesGrowthAJ, ...legalProfilesGrowthAK, ...legalProfilesGrowthAL, ...legalProfilesGrowthAM, ...legalProfilesGrowthAN,
] as LegalProfileV3[];
...
const reserveComponents = [
  ...
  ...reserveComponentsBatchAC, ...reserveComponentsBatchAD, ...reserveComponentsBatchAE, ...reserveComponentsBatchAF,
  ...reserveComponentsBatchAG, ...reserveComponentsBatchAH, ...reserveComponentsBatchAI, ...reserveComponentsBatchAJ,
  ...reserveComponentsBatchAK, ...reserveComponentsBatchAL, ...reserveComponentsBatchAM, ...reserveComponentsBatchAN,
