...
const stablecoins = [...(stablecoinsData as StablecoinRow[]), ...(stablecoinsExtraData as StablecoinRow[]), ...(stablecoinsBatchBData as StablecoinRow[]), ...(stablecoinsBatchCData as StablecoinRow[]), ...(stablecoinsBatchDData as StablecoinRow[]), ...(stablecoinsBatchEData as StablecoinRow[]), ...(stablecoinsBatchFData as StablecoinRow[])].map((coin) => ({ ...coin, ...(stablecoinOverridesById.get(coin.id) ?? {}), ...(classificationById.get(coin.id) ?? {}), ...(classificationExtensionById.get(coin.id) ?? {}), ...(getStablecoinProfile(coin.id) ?? {}) }));
...
const relationships = [...(relationshipsData as RelationshipRow[]), ...(relationshipsBatchBData as RelationshipRow[]), ...(relationshipsBatchCData as RelationshipRow[]), ...(relationshipsBatchDData as RelationshipRow[]), ...(relationshipsBatchEData as RelationshipRow[]), ...(relationshipsBatchFData as RelationshipRow[])];
const events = [...(eventsData as EventRow[]), ...(eventsPr036Data as EventRow[]), ...(eventsPr037Data as EventRow[]), ...(eventsPr038Data as EventRow[]), ...(eventsBatchAData as EventRow[]), ...(eventsBatchBData as EventRow[]), ...(eventsBatchCData as EventRow[]), ...(eventsBatchDData as EventRow[]), ...(eventsBatchEData as EventRow[]), ...(eventsBatchFData as EventRow[]), ...(eventsIssuerControl2026Data as EventRow[])].map((event) => ({ ...event, ...(eventDetailsById.get(event.id) ?? {}) }));
...
const reserveReports = [...(reserveReportsData as ReserveReportRow[]), ...(reserveReportsExtraData as ReserveReportRow[]), ...(reserveReportsPr033Data as ReserveReportRow[]), ...(reserveReportsPr034Data as ReserveReportRow[]), ...(reserveReportsBatchBData as ReserveReportRow[]), ...(reserveReportsBatchFData as ReserveReportRow[])];
...
const deployments = [...(deploymentsData as DeploymentRow[]), ...(deploymentsExtraData as DeploymentRow[]), ...(deploymentsBatchAData as DeploymentRow[]), ...(deploymentsBatchBData as DeploymentRow[]), ...(deploymentsBatchCData as DeploymentRow[]), ...(deploymentsBatchDData as DeploymentRow[]), ...(deploymentsBatchEData as DeploymentRow[]), ...(deploymentsBatchFData as DeploymentRow[]), ...(deploymentsIssuerControl2026Data as DeploymentRow[])];
