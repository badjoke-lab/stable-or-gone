...
const classificationById = new Map([
  ...
  ...(stablecoinClassificationBatchYData as StablecoinRow[])
...
const detailsById = new Map([
  ...
  ...(eventDetailsBatchXData as EventRow[]), ...(eventDetailsBatchYData as EventRow[])
].map((row) => [row.id, row] as const));
const batchStablecoins = [
  ...
  ...(stablecoinsBatchYData as StablecoinRow[])
...
const batchOrganizations = [
  ...
  ...(organizationsBatchYData as OrganizationRow[])
...
const batchRelationships = [
  ...
  ...(relationshipsBatchYData as RelationshipRow[])
];
const batchEvents = [
...
const batchEvidence = [
  ...
  ...(evidenceBatchYData as EvidenceRow[]), ...(evidenceQualityPr219Data as EvidenceRow[])
].map((row) => ({
  ...row,
