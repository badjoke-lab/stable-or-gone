...
stablecoins.json stablecoins-extra.json stablecoins-batch-b.json stablecoins-batch-c.json stablecoins-batch-d.json stablecoins-batch-e.json stablecoins-batch-f.json stablecoins-batch-g.json stablecoins-batch-h.json stablecoins-batch-i.json stablecoins-batch-j.json stablecoins-batch-k.json stablecoins-batch-l.json stablecoins-batch-m.json stablecoins-batch-n.json stablecoins-batch-o.json stablecoins-batch-p.json stablecoins-batch-q.json stablecoins-batch-r.json stablecoins-batch-s.json stablecoins-batch-t.json stablecoins-batch-u.json
organizations.json organizations-batch-b.json organizations-batch-c.json organizations-batch-d.json organizations-batch-e.json organizations-batch-f.json organizations-batch-g.json organizations-batch-h.json organizations-batch-i.json organizations-batch-j.json organizations-batch-k.json organizations-batch-l.json organizations-batch-m.json organizations-batch-n.json organizations-batch-o.json organizations-batch-p.json organizations-batch-q.json organizations-batch-r.json organizations-batch-s.json organizations-batch-t.json organizations-batch-u.json
relationships.json relationships-batch-b.json relationships-batch-c.json relationships-batch-d.json relationships-batch-e.json relationships-batch-f.json relationships-batch-g.json relationships-batch-h.json relationships-batch-i.json relationships-batch-j.json relationships-batch-k.json relationships-batch-l.json relationships-batch-m.json relationships-batch-n.json relationships-batch-o.json relationships-batch-p.json relationships-batch-q.json relationships-batch-r.json relationships-batch-s.json relationships-batch-t.json relationships-batch-u.json
stablecoin-classification-v2.json stablecoin-classification-batch-a.json stablecoin-classification-batch-b.json stablecoin-classification-batch-c.json stablecoin-classification-batch-d.json stablecoin-classification-batch-e.json stablecoin-classification-batch-f.json stablecoin-classification-batch-g.json stablecoin-classification-batch-h.json stablecoin-classification-batch-i.json stablecoin-classification-batch-j.json stablecoin-classification-batch-k.json stablecoin-classification-batch-l.json stablecoin-classification-batch-m.json stablecoin-classification-extension-batch-a.json stablecoin-classification-batch-n.json stablecoin-classification-batch-o.json stablecoin-classification-batch-p.json stablecoin-classification-batch-q.json stablecoin-classification-batch-r.json stablecoin-classification-batch-s.json stablecoin-classification-batch-t.json stablecoin-classification-batch-u.json
stablecoin-profiles-v2.json stablecoin-profiles-batch-a.json stablecoin-profiles-batch-b.json stablecoin-profiles-batch-c.json stablecoin-profiles-batch-d.json stablecoin-profiles-batch-e.json stablecoin-profiles-batch-f.json stablecoin-profiles-batch-g.json stablecoin-profiles-batch-h.json stablecoin-profiles-batch-i.json stablecoin-profiles-batch-j.json stablecoin-profiles-batch-k.json stablecoin-profiles-batch-l.json stablecoin-profiles-batch-m.json stablecoin-profiles-batch-n.json stablecoin-profiles-batch-o.json stablecoin-profiles-batch-p.json stablecoin-profiles-batch-q.json r-profiles.json s-profiles.json batch-t-reserve-redemption.json batch-u-reserve-redemption.json
events.json events-pr036.json events-pr037.json events-pr038.json events-batch-a.json events-batch-b.json events-batch-c.json events-batch-d.json events-batch-e.json events-batch-f.json events-batch-g.json events-batch-h.json events-batch-i.json events-batch-j.json events-batch-k.json events-batch-l.json events-batch-m.json events-issuer-control-2026.json events-batch-n.json events-batch-o.json events-batch-p.json events-batch-q.json events-batch-r.json events-batch-s.json events-batch-t.json events-batch-u.json
event-details-v2.json event-details-batch-a.json event-details-batch-b.json event-details-batch-c.json event-details-batch-d.json event-details-batch-e.json event-details-batch-f.json event-details-batch-g.json event-details-batch-h.json event-details-batch-i.json event-details-batch-j.json event-details-batch-k.json event-details-batch-l.json event-details-batch-m.json event-details-issuer-control-2026.json event-details-batch-n.json event-details-batch-o.json event-details-batch-p.json event-details-batch-q.json event-details-batch-r.json event-details-batch-s.json event-details-batch-t-a.json event-details-batch-t-b.json event-details-batch-u.json
evidence.json evidence-extra.json evidence-pr033.json evidence-events-pr036.json evidence-events-pr037.json evidence-events-pr038.json evidence-batch-a.json evidence-batch-b.json evidence-batch-c.json evidence-batch-d.json evidence-batch-e.json evidence-batch-f.json evidence-batch-g.json evidence-batch-h.json evidence-batch-i.json evidence-batch-j.json evidence-batch-k.json evidence-batch-l-a.json evidence-batch-l-b.json evidence-batch-l-c.json evidence-batch-l-d1.json evidence-batch-l-d2.json evidence-batch-m.json evidence-issuer-control-2026.json evidence-batch-n.json evidence-batch-o.json evidence-batch-p.json evidence-batch-q.json evidence-batch-r.json evidence-batch-s.json evidence-batch-t.json evidence-batch-t-b1.json evidence-batch-t-b2.json evidence-batch-u.json evidence-quality-pr219.json
reserve-reports.json reserve-reports-extra.json reserve-reports-pr033.json reserve-reports-pr034.json reserve-reports-batch-b.json reserve-reports-batch-f.json reserve-reports-batch-g.json reserve-reports-batch-h.json reserve-reports-batch-i.json reserve-reports-batch-j.json reserve-reports-batch-k.json reserve-reports-batch-l.json reserve-reports-batch-m-a.json reserve-reports-batch-m-b.json reserve-reports-batch-n.json reserve-reports-batch-o.json reserve-reports-batch-p.json reserve-reports-batch-q.json r-protocol-context.json s-protocol-context.json batch-t-context.json batch-u-context.json
known-unknowns.json known-unknowns-extra.json known-unknowns-pr033.json known-unknowns-pr034.json known-unknowns-batch-a.json known-unknowns-batch-b.json known-unknowns-batch-c.json known-unknowns-batch-d.json known-unknowns-batch-e.json known-unknowns-batch-f.json known-unknowns-batch-g.json known-unknowns-batch-h.json known-unknowns-batch-i.json known-unknowns-batch-j.json known-unknowns-batch-k.json known-unknowns-batch-l-a.json known-unknowns-batch-l-b.json known-unknowns-batch-m.json known-unknowns-issuer-control-2026.json known-unknowns-batch-n.json known-unknowns-batch-o.json known-unknowns-batch-p.json q-open-items.json r-open-items.json s-open-items.json batch-t-review-gaps.json batch-u-review-gaps.json
regulatory-notes.json
deployments.json deployments-extra.json deployments-batch-a.json deployments-batch-b.json deployments-batch-c.json deployments-batch-d.json deployments-batch-e.json deployments-batch-f.json deployments-batch-g.json deployments-batch-h.json deployments-batch-i.json deployments-batch-j.json deployments-batch-k.json deployments-batch-l.json deployments-batch-m.json deployments-issuer-control-2026.json deployments-batch-n.json deployments-batch-o.json deployments-batch-p.json deployments-batch-q.json deployments-batch-r.json deployments-batch-s.json batch-t-deployments.json batch-u-deployments.json
`;
...
const classificationById = new Map([
  ...
  ...(stablecoinClassificationBatchUData as StablecoinRow[])
...
const batchStablecoins = [
  ...
  ...(stablecoinsBatchUData as StablecoinRow[])
...
const batchOrganizations = [
  ...
  ...(organizationsBatchUData as OrganizationRow[])
...
const batchRelationships = [
  ...
  ...(relationshipsBatchUData as RelationshipRow[])
];
const batchEvents = [
...
const batchEvidence = [
  ...
  ...(evidenceBatchUData as EvidenceRow[]), ...(evidenceQualityPr219Data as EvidenceRow[])
].map((row) => ({
  ...row,
