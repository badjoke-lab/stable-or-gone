...
organizations.json organizations-batch-b.json organizations-batch-c.json organizations-batch-d.json organizations-batch-e.json organizations-batch-f.json organizations-batch-g.json organizations-batch-h.json organizations-batch-i.json organizations-batch-j.json organizations-batch-k.json organizations-batch-l.json organizations-batch-m.json organizations-batch-n.json organizations-batch-o.json organizations-batch-p.json organizations-batch-q.json
relationships.json relationships-batch-b.json relationships-batch-c.json relationships-batch-d.json relationships-batch-e.json relationships-batch-f.json relationships-batch-g.json relationships-batch-h.json relationships-batch-i.json relationships-batch-j.json relationships-batch-k.json relationships-batch-l.json relationships-batch-m.json relationships-batch-n.json relationships-batch-o.json relationships-batch-p.json relationships-batch-q.json
stablecoin-classification-v2.json stablecoin-classification-batch-a.json stablecoin-classification-batch-b.json stablecoin-classification-batch-c.json stablecoin-classification-batch-d.json stablecoin-classification-batch-e.json stablecoin-classification-batch-f.json stablecoin-classification-batch-g.json stablecoin-classification-batch-h.json stablecoin-classification-batch-i.json stablecoin-classification-batch-j.json stablecoin-classification-batch-k.json stablecoin-classification-batch-l.json stablecoin-classification-batch-m.json stablecoin-classification-extension-batch-a.json stablecoin-classification-batch-n.json stablecoin-classification-batch-o.json stablecoin-classification-batch-p.json stablecoin-classification-batch-q.json
stablecoin-profiles-v2.json stablecoin-profiles-batch-a.json stablecoin-profiles-batch-b.json stablecoin-profiles-batch-c.json stablecoin-profiles-batch-d.json stablecoin-profiles-batch-e.json stablecoin-profiles-batch-f.json stablecoin-profiles-batch-g.json stablecoin-profiles-batch-h.json stablecoin-profiles-batch-i.json stablecoin-profiles-batch-j.json stablecoin-profiles-batch-k.json stablecoin-profiles-batch-l.json stablecoin-profiles-batch-m.json stablecoin-profiles-batch-n.json stablecoin-profiles-batch-o.json stablecoin-profiles-batch-p.json stablecoin-profiles-batch-q.json
events.json events-pr036.json events-pr037.json events-pr038.json events-batch-a.json events-batch-b.json events-batch-c.json events-batch-d.json events-batch-e.json events-batch-f.json events-batch-g.json events-batch-h.json events-batch-i.json events-batch-j.json events-batch-k.json events-batch-l.json events-batch-m.json events-issuer-control-2026.json events-batch-n.json events-batch-o.json events-batch-p.json events-batch-q.json
event-details-v2.json event-details-batch-a.json event-details-batch-b.json event-details-batch-c.json event-details-batch-d.json event-details-batch-e.json event-details-batch-f.json event-details-batch-g.json event-details-batch-h.json event-details-batch-i.json event-details-batch-j.json event-details-batch-k.json event-details-batch-l.json event-details-batch-m.json event-details-issuer-control-2026.json event-details-batch-n.json event-details-batch-o.json event-details-batch-p.json event-details-batch-q.json
evidence.json evidence-extra.json evidence-pr033.json evidence-events-pr036.json evidence-events-pr037.json evidence-events-pr038.json evidence-batch-a.json evidence-batch-b.json evidence-batch-c.json evidence-batch-d.json evidence-batch-e.json evidence-batch-f.json evidence-batch-g.json evidence-batch-h.json evidence-batch-i.json evidence-batch-j.json evidence-batch-k.json evidence-batch-l-a.json evidence-batch-l-b.json evidence-batch-l-c.json evidence-batch-l-d1.json evidence-batch-l-d2.json evidence-batch-m.json evidence-issuer-control-2026.json evidence-batch-n.json evidence-batch-o.json evidence-batch-p.json evidence-batch-q.json evidence-quality-pr219.json
reserve-reports.json reserve-reports-extra.json reserve-reports-pr033.json reserve-reports-pr034.json reserve-reports-batch-b.json reserve-reports-batch-f.json reserve-reports-batch-g.json reserve-reports-batch-h.json reserve-reports-batch-i.json reserve-reports-batch-j.json reserve-reports-batch-k.json reserve-reports-batch-l.json reserve-reports-batch-m-a.json reserve-reports-batch-m-b.json reserve-reports-batch-n.json reserve-reports-batch-o.json reserve-reports-batch-p.json reserve-reports-batch-q.json
...
deployments.json deployments-extra.json deployments-batch-a.json deployments-batch-b.json deployments-batch-c.json deployments-batch-d.json deployments-batch-e.json deployments-batch-f.json deployments-batch-g.json deployments-batch-h.json deployments-batch-i.json deployments-batch-j.json deployments-batch-k.json deployments-batch-l.json deployments-batch-m.json deployments-issuer-control-2026.json deployments-batch-n.json deployments-batch-o.json deployments-batch-p.json deployments-batch-q.json
`;
...
const classificationById = new Map([
  ...
  ...(stablecoinClassificationBatchMData as StablecoinRow[]),
  ...(stablecoinClassificationBatchNData as StablecoinRow[]),
  ...(stablecoinClassificationBatchOData as StablecoinRow[]),
  ...(stablecoinClassificationBatchPData as StablecoinRow[]),
  ...(stablecoinClassificationBatchQData as StablecoinRow[])
].map((row) => [row.id, row] as const));
const detailsById = new Map([
  ...(eventDetailsBatchKData as EventRow[]),
  ...(eventDetailsBatchLData as EventRow[]),
  ...(eventDetailsBatchMData as EventRow[]),
  ...(eventDetailsBatchNData as EventRow[]),
  ...(eventDetailsBatchOData as EventRow[]),
  ...(eventDetailsBatchPData as EventRow[]),
  ...(eventDetailsBatchQData as EventRow[])
].map((row) => [row.id, row] as const));
const batchStablecoins = [
  ...(stablecoinsBatchKData as StablecoinRow[]),
  ...(stablecoinsBatchLData as StablecoinRow[]),
  ...(stablecoinsBatchMData as StablecoinRow[]),
  ...(stablecoinsBatchNData as StablecoinRow[]),
  ...(stablecoinsBatchOData as StablecoinRow[]),
  ...(stablecoinsBatchPData as StablecoinRow[]),
  ...(stablecoinsBatchQData as StablecoinRow[])
...
const batchOrganizations = [
  ...
  ...(organizationsBatchMData as OrganizationRow[]),
  ...(organizationsBatchNData as OrganizationRow[]),
  ...(organizationsBatchOData as OrganizationRow[]),
  ...(organizationsBatchPData as OrganizationRow[]),
  ...(organizationsBatchQData as OrganizationRow[])
...
const batchRelationships = [
  ...
  ...(relationshipsBatchMData as RelationshipRow[]),
  ...(relationshipsBatchNData as RelationshipRow[]),
  ...(relationshipsBatchOData as RelationshipRow[]),
  ...(relationshipsBatchPData as RelationshipRow[]),
  ...(relationshipsBatchQData as RelationshipRow[])
];
const batchEvents = [
  ...(eventsBatchKData as EventRow[]),
  ...(eventsBatchLData as EventRow[]),
  ...(eventsBatchMData as EventRow[]),
  ...(eventsBatchNData as EventRow[]),
  ...(eventsBatchOData as EventRow[]),
  ...(eventsBatchPData as EventRow[]),
  ...(eventsBatchQData as EventRow[])
...
const batchEvidence = [
  ...
  ...(evidenceBatchQData as EvidenceRow[]),
