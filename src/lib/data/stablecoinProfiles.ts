...
import stablecoinsBatchAGData from '../../../data/stablecoins-batch-ag.json';
import stablecoinsBatchAHData from '../../../data/stablecoins-batch-ah.json';
import stablecoinsBatchAIData from '../../../data/stablecoins-batch-ai.json';
...
import stablecoinClassificationBatchAGData from '../../../data/stablecoin-classification-batch-ag.json';
import stablecoinClassificationBatchAHData from '../../../data/stablecoin-classification-batch-ah.json';
import stablecoinClassificationBatchAIData from '../../../data/stablecoin-classification-batch-ai.json';
...
import organizationsBatchAGData from '../../../data/organizations-batch-ag.json';
import organizationsBatchAHData from '../../../data/organizations-batch-ah.json';
import organizationsBatchAIData from '../../../data/organizations-batch-ai.json';
...
import relationshipsBatchAGData from '../../../data/relationships-batch-ag.json';
import relationshipsBatchAHData from '../../../data/relationships-batch-ah.json';
import relationshipsBatchAIData from '../../../data/relationships-batch-ai.json';
...
import eventsBatchAGData from '../../../data/events-batch-ag.json';
import eventsBatchAHData from '../../../data/events-batch-ah.json';
import eventsBatchAIData from '../../../data/events-batch-ai.json';
...
import eventDetailsBatchAGData from '../../../data/event-details-batch-ag.json';
import eventDetailsBatchAHData from '../../../data/event-details-batch-ah.json';
import eventDetailsBatchAIData from '../../../data/event-details-batch-ai.json';
...
import evidenceBatchAGData from '../../../data/evidence-batch-ag.json';
import evidenceBatchAHData from '../../../data/evidence-batch-ah.json';
import evidenceBatchAIData from '../../../data/evidence-batch-ai.json';
...
import reviewGapsBatchAGData from '../../../data/batch-ag-review-gaps.json';
import reviewGapsBatchAHData from '../../../data/batch-ah-review-gaps.json';
import reviewGapsBatchAIData from '../../../data/batch-ai-review-gaps.json';
...
import deploymentsBatchAGData from '../../../data/batch-ag-deployments.json';
import deploymentsBatchAHData from '../../../data/batch-ah-deployments.json';
import deploymentsBatchAIData from '../../../data/batch-ai-deployments.json';
...
appendUniqueRows(stablecoinsBatchACData as IdentifiedRow[], stablecoinsBatchAGData as IdentifiedRow[]);
appendUniqueRows(stablecoinsBatchACData as IdentifiedRow[], stablecoinsBatchAHData as IdentifiedRow[]);
appendUniqueRows(stablecoinsBatchACData as IdentifiedRow[], stablecoinsBatchAIData as IdentifiedRow[]);
...
appendUniqueRows(stablecoinClassificationBatchACData as IdentifiedRow[], stablecoinClassificationBatchAGData as IdentifiedRow[]);
appendUniqueRows(stablecoinClassificationBatchACData as IdentifiedRow[], stablecoinClassificationBatchAHData as IdentifiedRow[]);
appendUniqueRows(stablecoinClassificationBatchACData as IdentifiedRow[], stablecoinClassificationBatchAIData as IdentifiedRow[]);
...
appendUniqueRows(organizationsBatchACData as IdentifiedRow[], organizationsBatchAGData as IdentifiedRow[]);
appendUniqueRows(organizationsBatchACData as IdentifiedRow[], organizationsBatchAHData as IdentifiedRow[]);
appendUniqueRows(organizationsBatchACData as IdentifiedRow[], organizationsBatchAIData as IdentifiedRow[]);
...
appendUniqueRows(relationshipsBatchACData as IdentifiedRow[], relationshipsBatchAGData as IdentifiedRow[]);
appendUniqueRows(relationshipsBatchACData as IdentifiedRow[], relationshipsBatchAHData as IdentifiedRow[]);
appendUniqueRows(relationshipsBatchACData as IdentifiedRow[], relationshipsBatchAIData as IdentifiedRow[]);
...
appendUniqueRows(eventsBatchACData as IdentifiedRow[], eventsBatchAGData as IdentifiedRow[]);
appendUniqueRows(eventsBatchACData as IdentifiedRow[], eventsBatchAHData as IdentifiedRow[]);
appendUniqueRows(eventsBatchACData as IdentifiedRow[], eventsBatchAIData as IdentifiedRow[]);
...
appendUniqueRows(eventDetailsBatchACData as IdentifiedRow[], eventDetailsBatchAGData as IdentifiedRow[]);
appendUniqueRows(eventDetailsBatchACData as IdentifiedRow[], eventDetailsBatchAHData as IdentifiedRow[]);
appendUniqueRows(eventDetailsBatchACData as IdentifiedRow[], eventDetailsBatchAIData as IdentifiedRow[]);
...
appendUniqueRows(evidenceBatchACData as IdentifiedRow[], evidenceBatchAGData as IdentifiedRow[]);
appendUniqueRows(evidenceBatchACData as IdentifiedRow[], evidenceBatchAHData as IdentifiedRow[]);
appendUniqueRows(evidenceBatchACData as IdentifiedRow[], evidenceBatchAIData as IdentifiedRow[]);
...
appendUniqueRows(reviewGapsBatchACData as IdentifiedRow[], reviewGapsBatchAGData as IdentifiedRow[]);
appendUniqueRows(reviewGapsBatchACData as IdentifiedRow[], reviewGapsBatchAHData as IdentifiedRow[]);
appendUniqueRows(reviewGapsBatchACData as IdentifiedRow[], reviewGapsBatchAIData as IdentifiedRow[]);
...
appendUniqueRows(deploymentsBatchACData as IdentifiedRow[], deploymentsBatchAGData as IdentifiedRow[]);
appendUniqueRows(deploymentsBatchACData as IdentifiedRow[], deploymentsBatchAHData as IdentifiedRow[]);
appendUniqueRows(deploymentsBatchACData as IdentifiedRow[], deploymentsBatchAIData as IdentifiedRow[]);
...
batch-ag-reserve-redemption.json
batch-ah-reserve-redemption.json
batch-ai-reserve-redemption.json
`;
