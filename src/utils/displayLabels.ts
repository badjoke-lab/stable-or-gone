const exactLabels: Record<string, string> = {
  ...
  non_redeemable_protocol_design: 'Non-redeemable protocol design',
  indirect_via_exchanges_wallets_or_partners: 'Indirect via exchanges, wallets, or partners',
  available_to_verified_customers_subject_to_terms: 'Available to verified customers, subject to terms',
  market_stress_liquidation_event: 'Market stress / liquidation event',
  rebrand_or_lifecycle_transition: 'Rebrand / lifecycle transition',
  reserve_intervention_context: 'Reserve intervention context',
  depeg_recovery_context: 'Depeg recovery context',
  protocol_launch_or_lifecycle_context: 'Protocol launch / lifecycle context',
  protocol_lifecycle_context: 'Protocol lifecycle context',
  launch_or_issuer_context: 'Launch / issuer context',
  exchange_adoption_context: 'Exchange adoption context',
  regulatory_action: 'Regulatory action',
  regulatory_settlement: 'Regulatory settlement',
  protocol_transition: 'Protocol transition',
  chain_halt_context: 'Chain halt context',
