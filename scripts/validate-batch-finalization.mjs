...
const patched = original.replace(
  anchor,
  `${anchor}, 'data/candidate-promotions-batch-k.json', 'data/candidate-promotions-batch-l.json', 'data/candidate-promotions-batch-m.json', 'data/candidate-promotions-batch-n.json'`
);
