...
if (!original.includes(anchor)) throw new Error('Batch K finalization patch anchor is missing');
const patched = original.replace(anchor, `${anchor}, 'data/candidate-promotions-batch-k.json'`);
