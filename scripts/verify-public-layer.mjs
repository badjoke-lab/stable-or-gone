...
const stablecoinsBase = [
  ...
  ...readRecords('data/stablecoins-batch-b.json'),
];
const stablecoins = applyById(stablecoinsBase, [
  ...
  readRecords('data/stablecoin-classification-batch-b.json'),
  ...
  readRecords('data/stablecoin-profiles-batch-b.json'),
]);
const organizations = [
  ...readRecords('data/organizations.json'),
  ...readRecords('data/organizations-batch-b.json'),
].map((row) => ({
  ...row,
  issuer_type: row.legacy_issuer_type || row.organization_type,
}));
const relationships = [
  ...readRecords('data/relationships.json'),
  ...readRecords('data/relationships-batch-b.json'),
];
const eventsBase = [
...
const evidence = [
  ...
  ...readRecords('data/evidence-batch-b.json'),
];
const reserveReports = [
  ...
  ...readRecords('data/reserve-reports-batch-b.json'),
];
const knownUnknowns = [
  ...
  ...readRecords('data/known-unknowns-batch-b.json'),
];
...
const deployments = [
  ...
  ...readRecords('data/deployments-batch-b.json'),
];
