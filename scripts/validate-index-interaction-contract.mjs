...
const expected={stablecoins:{route:'/stablecoins/',inputs:2,selects:1,headers:7},organizations:{route:'/issuers/',inputs:2,selects:1,headers:6},events:{route:'/events/',inputs:2,selects:1,headers:6}};
...
const validation={schema_version:'1.1',generated_at:new Date().toISOString(),ok:!failures.length,totals:{index_contracts:3,implemented_indexes:3,paginated_indexes:1,deferred_indexes:0,failures:failures.length},failures};
