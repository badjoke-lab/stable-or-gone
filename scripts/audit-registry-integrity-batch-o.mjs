...
const foundation = {
  ...
  data_groups: {
    ...
    legal_profiles: [...new Set([...(foundationBase.data_groups.legal_profiles ?? []), 'data/q-legal.json', 'data/r-legal.json', 'data/s-legal.json'])],
    reserve_components: [...new Set([...(foundationBase.data_groups.reserve_components ?? []), 'data/reserve-components-v3-batch-q.json', 'data/reserve-components-v3-batch-r.json', 'data/reserve-components-v3-batch-s.json'])]
  }
};`;
...
const incomeManifest = {
  ...incomeManifestBase,
  data_files: [...new Set([...(incomeManifestBase.data_files ?? []), 'data/yield-profiles-v3-q.json', 'data/r-returns.json', 'data/s-returns.json'])]
};`;
...
const patched = original
  ...
  .replaceAll('SOG 80-Record Final Registry Audit', 'SOG 98-Record Registry Audit')
  .replaceAll('SOG 87-Record Registry Audit', 'SOG 98-Record Registry Audit')
  .replaceAll('SOG 92-Record Registry Audit', 'SOG 98-Record Registry Audit')
  .replaceAll('SOG 94-Record Registry Audit', 'SOG 98-Record Registry Audit')
  .replaceAll('SOG 96-Record Registry Audit', 'SOG 98-Record Registry Audit')
  .replaceAll('The 80-record canonical registry', 'The 98-record canonical registry')
  .replaceAll('The 87-record canonical registry', 'The 98-record canonical registry')
  .replaceAll('The 92-record canonical registry', 'The 98-record canonical registry')
  .replaceAll('The 94-record canonical registry', 'The 98-record canonical registry')
  .replaceAll('The 96-record canonical registry', 'The 98-record canonical registry');
