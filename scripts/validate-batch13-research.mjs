...
check(research.canonical_assets === 80, 'canonical asset count must be 80');
...
check(master.protected_minimums?.total_candidates === 80, 'candidate total must be 80');
check(master.protected_minimums?.promoted_candidates === 80, 'promoted total must be 80');
...
console.log('Batch 13 promotion contract valid: 5 promoted candidates, 80 canonical assets');
