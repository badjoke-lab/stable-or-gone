...
const legacyIssuers = group([
  'data/issuers.json','data/issuers-extra.json','data/issuers-batch-b.json','data/issuers-batch-c.json','data/issuers-batch-d.json','data/issuers-batch-e.json','data/issuers-batch-f.json','data/issuers-batch-g.json','data/issuers-batch-h.json','data/issuers-batch-i.json','data/issuers-batch-j.json','data/issuers-batch-k.json','data/issuers-batch-l.json','data/issuers-batch-m.json','data/issuers-batch-n.json','data/issuers-batch-o.json','data/issuers-batch-p.json','data/issuers-batch-q.json'
]);
...
for (const event of events) {
  ...
  if (event.issuer_id && Array.isArray(event.subject_organization_ids) && !event.subject_organization_ids.includes(event.issuer_id)) failures.push(`${label(event)} legacy issuer_id missing from subject array`);
}
