...
requireText(roadmap, 'Active workstream: EU/EEA stablecoin market-access research', 'docs/roadmap.md');
requireText(roadmap, 'Current item: PR #305 schedule amendment for research checkpoint 03', 'docs/roadmap.md');
requireText(roadmap, 'Next research item: PR #306 function-matrix checkpoint 03', 'docs/roadmap.md');
...
requireText(agents, 'Active: PR #305 checkpoint 03 schedule amendment', 'AGENTS.md');
requireText(agents, 'Next research: PR #306 function-matrix research checkpoint 03', 'AGENTS.md');
...
requireText(governance, 'PR #305 checkpoint 03 schedule amendment active', 'docs/spec-governance.md');
requireText(governance, 'PR #306 function-matrix checkpoint 03 next', 'docs/spec-governance.md');
requireText(governance, 'PR #307 market-access guide blocked until publication gates pass', 'docs/spec-governance.md');

requireText(nonUiPlan, 'PR #305 checkpoint 03 schedule amendment: active', 'docs/quality/non-ui-quality-program.md');
requireText(nonUiPlan, 'PR #306 function-matrix checkpoint 03: next', 'docs/quality/non-ui-quality-program.md');
...
requireText(marketAccessSpec, 'PR #305  checkpoint 03 schedule amendment', 'docs/quality/eu-stablecoin-market-access-research-and-monitoring-spec.md');
...
if (matrix.publication_gate?.function_level_matrix_complete !== false) failures.push('function-level matrix must remain incomplete before checkpoint 03');
if (matrix.publication_gate?.revolut_scope_confirmed !== false) failures.push('Revolut policy scope must remain unresolved before checkpoint 03');
...
console.log('100-record core workstream checks passed: PR #305 is the checkpoint 03 schedule amendment, PR #306 is the next research checkpoint, and PR #307 remains publication-gated.');
