...
const result = { schema_version: '1.1', ok: failures.length === 0, guide_pages: slugs.length, guide_index: 'editorial_register', guide_articles: 'editorial_article_with_toc_and_metadata', canonical_record_changes: 0, route_changes: 0, failures };
