...
check(audit.totals?.implemented_mobile_representations === 25, 'all protected tables require compact representations');
check(audit.totals?.explicit_mobile_representations === 17, 'explicit mobile representation count changed');
...
const result = {
  ...
  totals: {
    ...
    page_families: 11,
    table_contracts: 25,
    implemented_mobile_representations: 25,
