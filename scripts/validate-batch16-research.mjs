...
const dforce = candidates.find((row) => row.proposed_record_id === 'sog_st_solsticeusx');
check(dforce?.slug === 'solstice-usx', 'Solstice USX must use disambiguated slug');
check(dforce?.proposed_record_id !== 'sog_st_usx', 'Solstice USX must not reuse dForce USX record id');
