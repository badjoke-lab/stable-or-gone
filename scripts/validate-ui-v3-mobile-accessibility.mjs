...
check(brand.includes('MobileTableRuntime') && brand.includes('loadsGlobalRuntime'), 'mobile table runtime is not loaded once from the shared header');
for (const marker of [
  ...
  'Contract or identifier', 'Copy full identifier', "aria-live', 'polite'"
