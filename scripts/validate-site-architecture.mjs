...
check(grouped.length === 11, 'grouped navigation must include Compare and Stats');
...
check(audit.totals?.primary_navigation_items === 13, 'implemented navigation must contain 13 destinations');
