...
if (/overflow-x:\s*auto/.test(filterGridBlock)) throw new Error('Stablecoin filters may not use the rejected horizontal-scroll strip');
...
const cardBlock = declarationBlock(register, '.stablecoin-index-card');
if (!/border-radius:\s*12px/.test(cardBlock)) throw new Error('Mobile records must be visually bounded');
