...
Status: proposed reviewed authority from REVIEW_GATE
...
> 21金融機関が共同ステーブルコイン構想　MUFG・Goldman Sachsなどが2027年前半のUSD建て発行を目指す
...
The analysis section may discuss deposit substitution, reserve-income economics, competition with USDT/USDC, and consortium-bank incentives only as analysis, with wording that separates inference from stated institutional motives.
