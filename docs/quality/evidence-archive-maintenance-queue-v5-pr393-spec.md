...
Queue v5 contains at most ten unique manual-review candidates, all History v4 suppressions are excluded, no reviewed-reactivated identity is selected, all boundaries pass, and the next work item is `REVIEW GATE`.
