...
export const mobileTableContracts = Object.freeze([
  ...
  table('organization-index', 'record_cards', { grouping: 'one organization per card' }),
  table('event-index', 'timeline_cards', { grouping: 'one event per card' }),
  ...
  table('organization-overview', 'definition_list'),
  ...
  table('event-details', 'definition_list'),
