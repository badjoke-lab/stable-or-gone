...
export const syntheticDossierFields = Object.freeze([
  ...
  Object.freeze({ field_id: 'evidence.published_at', current_surface: 'EvidenceRows source metadata', source: 'evidence.published_at', destination_section: 'evidence', decision: 'move', required: true, public_label: 'Published', value_state: true }),
