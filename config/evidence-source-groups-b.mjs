export const evidenceSourceGroupsB = [
  ...
  ['sog_src_usds_sky_page', ['sog_src_dai_sky_transition_event'], 'https://sky.money/'],
  ['sog_src_usds_susds_page', ['sog_src_susds_product_batch_h'], 'https://sky.money/susds'],
  ['sog_src_tron_dao_reserve_site', ['sog_src_usdd_tron_dao_reserve'], 'https://tdr.org/'],
  ['sog_src_tether_legal_terms', ['sog_src_eurt_legal_batch_e'], 'https://tether.to/en/legal/'],
  ['sog_src_tether_tron_supported_protocol_2026', ['sog_src_eurt_protocols_batch_e'], 'https://tether.to/en/supported-protocols/']
];
